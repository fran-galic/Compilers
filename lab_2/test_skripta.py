...
# Paths
test_folder = r"D:\Fran\Documents\FER\5. semestar\PPJ\lab_vjezbe\2_lab_vjezba\ispitni_primjeri"
program_path = r"D:\Fran\Documents\FER\5. semestar\PPJ\lab_vjezbe\2_lab_vjezba\SintaksniAnalizator.py"
results_file = os.path.join(test_folder, "RESULTS.txt")

# Function to run a single test
def run_test(test_in, test_out):
    # Pokreni SintaksniAnalizator.py s ulaznom datotekom i hvataj izlaz
