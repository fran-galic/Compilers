frisc_asm = (function () {
  ...
  var result = {
    ...
    parse: function (input, startRule) {
        ...
        if (result0 !== null) {
          result0 = (function (offset, ins) {
            ...
            for (var i = 0; i < instrs.length; i++) {
              if (
                instrs[i].op in aluops ||
                instrs[i].op in cmpops ||
                instrs[i].op in moveops
              ) {
            ...
            for (
              var opCount = 0, memCount = 0;
              opCount < machinecode.length;
              ...
              if (typeof machinecode[opCount].curloc === "undefined") {
                ...
                if (machinecode[opCount].curloc > memCount) {
                  ...
                  if (typeof machinecode[opCount].machineCode === "string") {
                    memCount = writeToMemory(
                      machinecode[opCount].machineCode,
                      memCount,
                      mem
                    );
                  } else {
                    for (
                      var j = 0;
                      j < machinecode[opCount].machineCode.length;
                      j++
                    ) {
                      memCount = writeToMemory(
                        machinecode[opCount].machineCode[j],
                        memCount,
                        mem
                      );
                    }
        ...
        if (result0 !== null) {
          result0 = (function (offset, l, o, c) {
            ...
            if (
              ...
              if (
                typeof o.alusrc2 !== "undefined" &&
                o.alusrc2.type === "num"
              ) {
                if (
                  !canNumberBeObtainedBySignedExtendingThe20BitSuffix(
                    o.alusrc2.value
                  )
                ) {
                  var err = new Error(
                ...
                if (
                  o.alusrc2.value > 4294967295 ||
                  o.alusrc2.value < -2147483648
                ) {
              ...
              if (o.value < curloc) {
                var err = new Error(
                  "ORG op must not point to previous addresses."
                );
                err.line = linecounter;
                err.column = 1;
                throw err;
      ...
      var canNumberBeObtainedBySignedExtendingThe20BitSuffix = function (
        number
      ) {
      ...
      var generateMachineCode = function (node) {
        if (
          ...
          throw new Error(
            "Undefined instruction, operation or operation type." +
              JSON.stringify(node)
          );
        }
        ...
        switch (node.optype) {
          ...
          case "aluop":
            if (node.optype === "aluop") {
              setBits(
                ...
                23,
                25,
                convertIntToBinary(node.aludest.value, 3)
              );
            }
            setBits(
              machineCode,
              20,
              22,
              convertIntToBinary(node.alusrc1.value, 3)
            );
            ...
            if (node.alusrc2.type === "reg") {
              ...
              setBits(
                ...
                17,
                19,
                convertIntToBinary(node.alusrc2.value, 3)
              );
              ...
              setBits(
                ...
                0,
                19,
                convertIntToBinary(node.alusrc2.value, 20)
              );
            }
          ...
          case "jmpop":
            ...
            if (node.addr.type === "num") {
              ...
              setBits(
                ...
                0,
                19,
                convertIntToBinary(node.addr.value, 20)
              );
            } else {
              setBits(machineCode, 26, 26, "0");
              setBits(
                ...
                17,
                19,
                convertIntToBinary(node.addr.value, 3)
              );
            }
            break;
          case "rethaltop":
          ...
          case "memop":
            ...
            if (node.mem.type === "regoff") {
              ...
              setBits(
                ...
                20,
                22,
                convertIntToBinary(node.mem.value, 3)
              );
              setBits(
                machineCode,
                0,
                19,
                convertIntToBinary(node.mem.offset, 20)
              );
            } else {
              setBits(machineCode, 26, 26, "0");
              setBits(
                ...
                0,
                19,
                convertIntToBinary(node.mem.value, 20)
              );
            }
            break;
          case "stackop":
          ...
          case "dwhbop":
            for (var i = 0; i < node.values.length; i++) {
              machineCode.push(
                convertIntToBinary(node.values[i], node.size * 8)
              );
            }
            break;
        }
